...
$date_array = date_parse($node->notice_date['und'][0]['value']);
...
<div class="pg-about-main right-container p20bs"> 
  ...
  <div class="article fn-clear">
    ...
    <p>&nbsp;</p> 
    <p>&nbsp;</p> 
    <p style="text-align: right;"><?php print $notice_publisher[0]['value']; ?></p> 
  ...
  <div class="bottom mt20 text-center">  
    ...
    <br />
    <li class="viewall">
      <a href="<?php print $base_url;?>/about/notices" title="全部文章">全部文章</a>
    </li>
  </div> 
</div> 