  ...
  <div class="inputs">
    <div class="ui-form-item">
      <label class="ui-label"><span class="ui-form-required">*</span>昵称</label>
       ...
       </form><form data-name="userbasic" enctype="multipart/form-data" class="ui-form" method="post" id="userInfoForm" action="/account/info!saveBasicInfo.action" novalidate="novalidate">
        <div class="userphoto" id="userphoto">
